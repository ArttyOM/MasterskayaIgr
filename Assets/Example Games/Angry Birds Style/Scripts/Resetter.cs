...
public class Resetter : MonoBehaviour
{
    ...
    public float
        resetSpeed = 0.025f; //	The angular velocity threshold of the projectile, below which our game will reset
    ...
    private void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.R)) //	... call the Reset() function
            Reset();
        ...
        if (spring == null && projectile.velocity.sqrMagnitude < resetSpeedSqr) //	... call the Reset() function
            Reset();
    }
    ...
    private void OnTriggerExit2D(Collider2D other)
    {
        ...
        if (other.GetComponent<Rigidbody2D>() == projectile) //	... call the Reset() function
            Reset();
    }
