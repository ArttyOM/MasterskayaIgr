...
public class ObjectPool : MonoBehaviour
{
    public static ObjectPool
        current; //A public static reference to itself (make's it visible to other objects without a reference)
    ...
    private GameObject
        containerObject; //A parent object for pooled objects to be nested under. Keeps the hierarchy clean
    ...
    private void Awake()
    {
        ...
        foreach (var objectPrefab in prefabs)
        {
