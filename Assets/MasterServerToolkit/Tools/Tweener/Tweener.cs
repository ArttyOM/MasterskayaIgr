...
namespace MasterServerToolkit.Utils
{
    ...
    public partial class Tweener : IUpdatable
    {
        ...
        private static readonly ConcurrentDictionary<int, Func<bool>> actions = new();
        private static readonly ConcurrentDictionary<int, TweenerActionInfoCallback> onCompleted = new();
