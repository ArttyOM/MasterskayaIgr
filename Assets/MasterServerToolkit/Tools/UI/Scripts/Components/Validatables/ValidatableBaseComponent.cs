...
namespace MasterServerToolkit.UI
{
    public class ValidatableBaseComponent : MonoBehaviour, IValidatableComponent
    {
        ...
        [SerializeField] protected bool changeValidationColor = true;

        [Header("Graphics")] [SerializeField] protected Graphic[] validationTargetGraphic;
        ...
        {
            if (validationTargetGraphic == null || validationTargetGraphic.Length == 0 ||
                !changeValidationColor) return;

            for (var i = 0; i < validationTargetGraphic.Length; i++) validationTargetGraphic[i].color = invalidColor;
        }
        ...
        protected void TransitionToStartColor()
        {
            ...
            for (var i = 0; i < validationColorAtStart.Length; i++)
                validationTargetGraphic[i].color = Color.Lerp(validationTargetGraphic[i].color,
                    validationColorAtStart[i], Time.deltaTime);
        }
        ...
        protected void RememberStartValidationGraphicColor()
        {
            ...
            for (var i = 0; i < validationTargetGraphic.Length; i++)
