...
namespace MasterServerToolkit.UI
{
    ...
    public class UIViewSync : MonoBehaviour
    {
        ...
        [Header("Settings")] [SerializeField] protected bool listenToShowEvent = true;
        [SerializeField] protected bool listenToHideEvent = true;
        [SerializeField] protected bool invokeInstantly = false;
        ...
        private void OnShowEventHandler()
        {
            if (listenToShowEvent)
                foreach (var view in syncedViews.ToList().Where(v => v))
