...
namespace MasterServerToolkit.UI
{
    ...
    public class UIView : MonoBehaviour, IUIView
    {
        ...
        [Header("Events")] public UnityEvent OnShowEvent;
        ...
        protected Dictionary<string, IUIViewComponent> uiViewComponents = new();
        ...
        public bool IgnoreHideAll
        {
            get => ignoreHideAll;
            set => ignoreHideAll = value;
        }
        ...
        protected virtual void Awake()
        {
            ...
            foreach (var uiViewComponent in uiViewComponents.Values) uiViewComponent.OnOwnerAwake();
        ...
        {
            foreach (var uiComponent in uiViewComponents.Values) uiComponent.OnOwnerStart();
        }
        ...
        {
            var childId = $"{childName}_{typeof(T).Name}";
            ...
            else
            {
                ...
                if (newChild) children.Add(childId, newChild);
        ...
        private void NotifyComponentsOnShow(bool show)
        {
            if (show)
            {
                ...
                foreach (var uiComponent in uiViewComponents) uiComponent.Value?.OnOwnerShow(this);
            }
            else
            {
                OnHide();

                foreach (var uiComponent in uiViewComponents) uiComponent.Value?.OnOwnerHide(this);
            }
        }
