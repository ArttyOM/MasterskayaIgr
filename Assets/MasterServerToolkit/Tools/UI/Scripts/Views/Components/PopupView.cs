...
namespace MasterServerToolkit.UI
{
    public class PopupView : UIView
    {
        ...
        public virtual void SetLables(params string[] values)
        {
            ...
            {
                logger.Warn(
                    $"There is no need to use SetLables method of {name} because of you do not pass any values as its parameters");
                return;
            }
        ...
        public virtual void SetButtonsClick(params UnityAction[] actions)
        {
            ...
            {
                logger.Warn(
                    $"There is no need to use SetButtonsClick method of {name} because of you do not pass any action as its parameters");
                return;
            }
