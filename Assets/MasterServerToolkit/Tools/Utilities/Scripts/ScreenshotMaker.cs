...
namespace MasterServerToolkit.Utils
{
    public class ScreenshotMaker : SingletonBehaviour<ScreenshotMaker>
    {
        ...
        [Header("Settings")] public int resolutionMultiplier = 2;
        ...
        {
            if (Input.GetKeyDown(screenshoKey)) TakeScreenshot();
        }

        private void TakeScreenshot()
        {
            var rt = new RenderTexture(resWidth, resHeight, 24);
            var screenShot = new Texture2D(resWidth, resHeight, format, false);
