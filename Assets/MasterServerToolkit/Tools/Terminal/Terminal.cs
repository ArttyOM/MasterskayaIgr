...
namespace MasterServerToolkit.CommandTerminal
{
    ...
    public class Terminal : SingletonBehaviour<Terminal>
    {
        ...
        [Header("Theme")] [Range(0, 1)] [SerializeField]
        ...
        public static CommandShell Shell { get; private set; } = new();
        public static CommandHistory History { get; private set; } = new();
        public static CommandAutocomplete Autocomplete { get; private set; } = new();
        ...
        private void Start()
        {
            ...
            foreach (var command in Shell.Commands) Autocomplete.Register(command.Key);
        }
