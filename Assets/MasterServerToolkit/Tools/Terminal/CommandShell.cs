    ...
    public struct CommandArg
    {
        ...
        public int Int
        {
            get
            {
                ...
                if (int.TryParse(String, out int_value)) return int_value;
        ...
        public float Float
        {
            get
            {
                ...
                if (float.TryParse(String, out float_value)) return float_value;
        ...
        public bool Bool
        {
            get
            {
                if (string.Compare(String, "TRUE", true) == 0) return true;

                if (string.Compare(String, "FALSE", true) == 0) return false;
    ...
    public class CommandShell
    {
        ...
        public void RunCommand(string line)
        {
            ...
            while (remaining != "")
            {
                ...
                if (argument.String != "") arguments.Add(argument);
            }
