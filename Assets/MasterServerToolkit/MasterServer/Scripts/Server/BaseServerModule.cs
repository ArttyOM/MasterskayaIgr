...
namespace MasterServerToolkit.MasterServer
{
    public abstract class BaseServerModule : MonoBehaviour, IBaseServerModule
    {
        ...
        /// </summary>
        public List<Type> Dependencies { get; private set; } = new();

        /// <summary>
        /// Returns a list of module types this module depends on
        /// </summary>
        public List<Type> OptionalDependencies { get; private set; } = new();
        ...
        {
            if (instances == null) instances = new Dictionary<Type, GameObject>();
        ...
        public virtual MstJson JsonInfo()
        {
            ...
            try
            {
                ...
                if (Dependencies.Count > 0)
                {
                    ...
                    for (var i = 0; i < Dependencies.Count; i++) dependenciesArray.Add(Dependencies[i].Name);
                ...
                if (OptionalDependencies.Count > 0)
                {
                    ...
                    for (var i = 0; i < OptionalDependencies.Count; i++)
