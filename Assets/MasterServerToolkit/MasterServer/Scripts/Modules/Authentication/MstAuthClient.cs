    ...
    public class MstAuthClient : MstBaseClient
    {
        ...
        public string DeviceId()
        {
            ...
            else
            {
                ...
                {
                    var deviceId = Mst.Helper.CreateGuidStringN();
        ...
        public bool HasAuthToken()
        {
            ...
            {
                var key = PlayerPrefs.GetString(MstDictKeys.USER_AUTH_TOKEN);
        ...
        public void SignOut(IClientSocket connection, bool permanent = false)
        {
            ...
            if (connection != null && connection.IsConnected) connection.Reconnect();
