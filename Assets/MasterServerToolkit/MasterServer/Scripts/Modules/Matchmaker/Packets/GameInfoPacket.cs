...
namespace MasterServerToolkit.MasterServer
{
    public class GameInfoPacket : SerializablePacket, IEquatable<GameInfoPacket>
    {
        ...
        public override void ToBinaryWriter(EndianBinaryWriter writer)
        {
            ...
            var count = (ushort) OnlinePlayersList.Count;

            writer.Write(count);

            foreach (var player in OnlinePlayersList) writer.Write(player);
        ...
        public override void FromBinaryReader(EndianBinaryReader reader)
        {
            ...
            for (var i = 0; i < count; i++) OnlinePlayersList.Add(reader.ReadString());
        ...
        {
            var maxPleyers = MaxPlayers <= 0 ? "Unlimited" : MaxPlayers.ToString();
