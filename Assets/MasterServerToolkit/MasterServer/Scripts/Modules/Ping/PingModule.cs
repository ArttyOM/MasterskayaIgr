...
namespace MasterServerToolkit.MasterServer
{
    public class PingModule : BaseServerModule
    {
        ...
        [SerializeField] [TextArea(3, 5)] private string pongMessage = "Hello, Pong!";
        ...
        public override MstJson JsonInfo()
        {
            ...
            data.SetField("description",
                $"This is just a ping testing module that sends a response message \"{pongMessage}\" to any client who has made a request.");
            return data;
        }
        ...
        public override MstProperties Info()
        {
            ...
            properties.Set("Description",
                $"This is just a ping testing module that sends a response message \"<b>{pongMessage}</b>\" to any client who has made a request.");
            return properties;
        }
    }
}