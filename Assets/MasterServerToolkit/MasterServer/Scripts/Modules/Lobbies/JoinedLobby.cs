...
namespace MasterServerToolkit.MasterServer
{
    ...
    public class JoinedLobby
    {
        ...
        /// Name of the lobby
        /// </summary>
        public string Name => Data.LobbyName;
        ...
        public JoinedLobby(LobbyDataPacket data, IClientSocket connection)
        {
            ...
            connection.RegisterMessageHandler(MstOpCodes.LobbyMemberReadyStatusChange,
                HandleLobbyMemberReadyStatusChangeMsg);
