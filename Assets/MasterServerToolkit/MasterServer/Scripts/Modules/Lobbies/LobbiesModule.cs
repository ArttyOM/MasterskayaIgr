...
namespace MasterServerToolkit.MasterServer
{
    public class LobbiesModule : BaseServerModule, IGamesProvider
    {
        ...
        [Header("Configuration")] public int createLobbiesPermissionLevel = 0;
        ...
        public void AddFactory(ILobbyFactory factory)
        {
            ...
            if (factories == null) factories = new Dictionary<string, ILobbyFactory>();

            if (factories.ContainsKey(factory.Id)) logger.Warn("You are overriding a factory with same id");
        ...
        protected virtual void CreateLobbyHandle(IIncomingMessage message)
        {
            ...
            var lobbyFactoryId = options.AsString(MstDictKeys.LOBBY_FACTORY_ID);
            ...
            factories.TryGetValue(lobbyFactoryId, out var factory);
        ...
        protected virtual void JoinLobbyHandler(IIncomingMessage message)
        {
            ...
            if (!lobby.AddPlayer(lobbyUser, out var error))
            {
        ...
        protected virtual void LeaveLobbyHandler(IIncomingMessage message)
        {
            ...
            if (lobby != null) lobby.RemovePlayer(lobbiesExt);
        ...
        {
            var lobbiesList = filters != null && filters.Has(MstDictKeys.ROOM_ID)
                ? lobbies.Values.Where(l => l.Id == filters.AsInt(MstDictKeys.ROOM_ID))
                : lobbies.Values;
