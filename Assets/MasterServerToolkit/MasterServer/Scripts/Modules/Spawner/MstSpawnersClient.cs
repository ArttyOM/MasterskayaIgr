...
namespace MasterServerToolkit.MasterServer
{
    public class MstSpawnersClient : MstBaseClient
    {
        ...
        /// <param name="region"></param>
        /// <param name="callback"></param>
        public void RequestSpawn(MstProperties options, MstProperties customOptions, string region,
            SpawnRequestResultHandler callback)
        {
        ...
        /// <param name="callback"></param>
        public void RequestSpawn(MstProperties options, MstProperties customOptions, string region,
            SpawnRequestResultHandler callback, IClientSocket connection)
        {
