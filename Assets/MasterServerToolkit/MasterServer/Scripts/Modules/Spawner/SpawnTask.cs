...
namespace MasterServerToolkit.MasterServer
{
    ...
    public class SpawnTask
    {
        ...
        /// </summary>
        public bool IsAborted => status < SpawnStatus.None;
        ...
        public SpawnStatus Status
        {
            ...
            set
            {
                ...
                if (status >= SpawnStatus.Finalized || status < SpawnStatus.None) NotifyDoneListeners();
            }
        }
        ...
        public void Abort()
        {
            if (Status >= SpawnStatus.Finalized) return;
        ...
        public void KillSpawnedProcess()
        {
            Spawner.SendKillRequest(Id, killed =>
            {
                ...
                if (!killed) Logs.Warn("Spawned Process might not have been killed");
            });
        }
