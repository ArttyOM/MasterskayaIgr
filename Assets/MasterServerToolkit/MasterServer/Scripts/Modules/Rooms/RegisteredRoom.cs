...
namespace MasterServerToolkit.MasterServer
{
    ...
    public class RegisteredRoom
    {
        ...
        /// </summary>
        public int OnlineCount => accessesInUse.Count;
        ...
        {
            unconfirmedAccesses.TryGetValue(token, out var data);
            ...
            if (!data.Peer.IsConnected) return false;
        ...
        public void RemovePlayer(int peerId)
        {
            ...
            if (!Players.TryGetValue(peerId, out var playerPeer))
                return;
        ...
        public void ClearTimedOutAccesses()
        {
            ...
            foreach (var access in timedOut) unconfirmedAccesses.Remove(access.Access.Token);
        }
        ...
        public void Destroy()
        {
            if (OnDestroyedEvent != null) OnDestroyedEvent.Invoke(this);
