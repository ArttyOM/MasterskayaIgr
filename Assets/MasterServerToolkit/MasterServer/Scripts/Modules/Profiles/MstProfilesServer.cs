...
namespace MasterServerToolkit.MasterServer
{
    public class MstProfilesServer : MstBaseClient
    {
        ...
        /// profile
        /// </summary>
        public void FillInProfileValues(ObservableServerProfile profile, SuccessCallback callback,
            IClientSocket connection)
        {
            ...
            connection.SendMessage(MstOpCodes.ServerFillInProfileValues, profile.UserId, (status, response) =>
            {
                ...
                profile.OnModifiedInServerEvent += serverProfile => { OnProfileModified(profile, connection); };
        ...
        private void OnProfileModified(ObservableServerProfile profile, IClientSocket connection)
        {
            ...
            if (sendUpdatesCoroutine != null) return;
        ...
        private IEnumerator KeepSendingUpdates(IClientSocket connection)
        {
            while (true)
            {
                ...
                if (modifiedProfilesList.Count == 0) continue;
