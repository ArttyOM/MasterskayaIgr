...
namespace MasterServerToolkit.MasterServer
{
    public class ObservableDictionaryInt : ObservableBaseDictionary<int, int>
    {
        ...
        public ObservableDictionaryInt(ushort key, ConcurrentDictionary<int, int> defaultValues) : base(key,
            defaultValues)
        {
        }
        ...
        public override MstJson ToJson()
        {
            ...
            foreach (var kvp in _value) json.AddField(kvp.Key.ToString(), kvp.Value);
        ...
        public override void FromJson(MstJson json)
        {
            ...
            foreach (var key in json.Keys) _value.TryAdd(Convert.ToInt32(key), json[key].IntValue);
        }
