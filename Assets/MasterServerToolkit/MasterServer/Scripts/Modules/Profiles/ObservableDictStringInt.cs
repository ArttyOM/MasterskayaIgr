...
namespace MasterServerToolkit.MasterServer
{
    public class ObservableDictStringInt : ObservableBaseDictionary<string, int>
    {
        ...
        public ObservableDictStringInt(ushort key, ConcurrentDictionary<string, int> defaultValues) : base(key,
            defaultValues)
        {
        }
        ...
        public override void Deserialize(string value)
        {
            ...
            foreach (var property in properties) _value[property.Key] = properties.AsInt(property.Key);
        }
        ...
        public override MstJson ToJson()
        {
            ...
            foreach (var kvp in _value) json.AddField(kvp.Key, kvp.Value);
        ...
        public override void FromJson(MstJson json)
        {
            ...
            foreach (var key in json.Keys) _value.TryAdd(key, json[key].IntValue);
        }
