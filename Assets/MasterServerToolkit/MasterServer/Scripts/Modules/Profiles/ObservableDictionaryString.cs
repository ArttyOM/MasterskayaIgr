...
namespace MasterServerToolkit.MasterServer
{
    public class ObservableDictionaryString : ObservableBaseDictionary<string, string>
    {
        ...
        public ObservableDictionaryString(ushort key, ConcurrentDictionary<string, string> defaultValues) : base(key,
            defaultValues)
        {
        }
        ...
        public override void FromJson(MstJson json)
        {
            ...
            foreach (var key in json.Keys) _value.TryAdd(key, json[key].StringValue);
        }
