...
namespace MasterServerToolkit.MasterServer
{
    public class ObservableDictStringFloat : ObservableBaseDictionary<string, float>
    {
        ...
        public ObservableDictStringFloat(ushort key, ConcurrentDictionary<string, float> defaultValues) : base(key,
            defaultValues)
        {
        }
        ...
        public override void FromJson(MstJson json)
        {
            ...
            foreach (var key in json.Keys) _value.TryAdd(key, json[key].FloatValue);
        }
