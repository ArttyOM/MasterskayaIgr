...
namespace MasterServerToolkit.MasterServer
{
    ...
    public delegate void ClientValidattorProviderDelegate(ProvideServerAccessCheckPacket accessCheckOptions,
    ...
    public class MstSecurity : MstBaseClient
    {
        ...
        /// </summary>
        private readonly ConcurrentDictionary<IClientSocket, EncryptionData> _encryptionData = new();
        ...
        {
            var deviceIdHash = CreateHash(SystemInfo.deviceUniqueIdentifier);
            var applicationKeyHash = CreateHash(Mst.Settings.ApplicationKey);
