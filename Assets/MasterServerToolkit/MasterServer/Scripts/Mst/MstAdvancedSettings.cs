...
namespace MasterServerToolkit.MasterServer
{
    ...
    public class MstAdvancedSettings
    {
        ...
        {
            get => Mst.Args.AsString(Mst.Args.Names.ApplicationKey, applicationKey).Trim();
        ...
        {
            get => Mst.Args.AsBool(Mst.Args.Names.UseSecure, useSecure);
            set => useSecure = value;
        }
        ...
        /// Path to certificate
        /// </summary>
        public string CertificatePath => Mst.Args.CertificatePath.Trim();

        /// <summary>
        /// Path to certificate
        /// </summary>
        public string CertificatePassword => Mst.Args.CertificatePassword.Trim();
