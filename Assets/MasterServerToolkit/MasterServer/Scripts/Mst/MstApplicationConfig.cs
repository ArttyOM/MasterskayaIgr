...
namespace MasterServerToolkit.MasterServer
{
    public class MstApplicationConfig : MonoBehaviour
    {
        ...
        [Tooltip("Unique application key. Must be the same both on client and on server.")]
        [SerializeField]
        ...
        [SerializeField] protected HelpBox securityInfo = new()
        {
            Text =
                "If \"Use Secure\" is enabled you are required to setup path and password of security certificate in application.cfg file",
