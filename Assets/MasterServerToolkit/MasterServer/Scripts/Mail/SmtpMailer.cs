...
namespace MasterServerToolkit.MasterServer
{
    public class SmtpMailer : Mailer
    {
        ...
        [Header("E-mail settings")] public string smtpHost = "smtp.mail.com";
        ...
        protected virtual void Update()
        {
            ...
            if (sendMailExceptions.Count > 0)
                ...
                {
                    foreach (var exception in sendMailExceptions) logger.Error(exception);
        ...
        public override async Task<bool> SendMailAsync(string to, string subject, string body)
        {
            ...
            try
            {
                ...
                var generatedMessageBody = htmlTemplate;
                ...
                if (!string.IsNullOrEmpty(htmlTemplate))
                {
                    ...
                    generatedMessageBody =
                        generatedMessageBody.Replace("#{MESSAGE_YEAR}", DateTime.Now.Year.ToString());
