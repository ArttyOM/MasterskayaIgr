...
namespace MasterServerToolkit.Bridges
{
    public class NoticeView : UIView
    {
        ...
        [Header("Settings")] [SerializeField] private int maxNotices = 5;

        [Header("Components")] [SerializeField]
        private RectTransform messagesContainer;

        [SerializeField] private NoticeItem noticeItemPrefab;

        [Header("Settings")] [SerializeField] private float destroyAfter = 5f;
        ...
        /// 
        /// </summary>
        private List<NoticeItem> noticeItems = new();
