...
namespace MasterServerToolkit.Bridges
{
    public class ClientConnectionStatusComponent : MonoBehaviour
    {
        ...
        [Header("Settings")] [SerializeField] private bool changeStatusColor = true;
        ...
        [SerializeField] private Color connectingStatusColor = Color.cyan;
        ...
        {
            var address = $"{Connection.Address}:{Connection.Port}";
