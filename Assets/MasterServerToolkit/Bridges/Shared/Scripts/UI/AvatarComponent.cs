...
namespace MasterServerToolkit.Bridges
{
    public class AvatarComponent : MonoBehaviour
    {
        ...
        {
            if (Uri.TryCreate(url, UriKind.Absolute, out var balidUri))
            {
                ...
                else
                {
                    ...
                    avatarImage.sprite =
 Sprite.Create(myTexture, new Rect(0f, 0f, myTexture.width, myTexture.height), new Vector2(0.5f, 0.5f), 100f);
                }
                    ...
                    {
                        var myTexture = ((DownloadHandlerTexture) www.downloadHandler).texture;
                        SetAvatarSprite(Sprite.Create(myTexture, new Rect(0f, 0f, myTexture.width, myTexture.height),
