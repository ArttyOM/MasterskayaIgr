...
namespace MasterServerToolkit.Bridges
{
    public class CreateNewRoomView : UIView
    {
        ...
        [SerializeField] private TMP_InputField roomMaxConnectionsInputField;
        [SerializeField] private TMP_Dropdown roomRegionNameInputDropdown;
        ...
        {
            get => roomMaxConnectionsInputField != null ? roomMaxConnectionsInputField.text : string.Empty;
        ...
        public string RegionName => roomRegionNameInputDropdown != null && roomRegionNameInputDropdown.options.Count > 0
            ? Mst.Client.Matchmaker.Regions[roomRegionNameInputDropdown.value].Name
            : string.Empty;
        ...
        public void CreateNewMatch()
        {
            ...
            MatchmakingBehaviour.Instance.CreateNewRoom(RegionName, spawnOptions, () => { Show(); });
        }
    }
}