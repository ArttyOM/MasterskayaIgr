...
namespace MasterServerToolkit.Bridges
{
    public class SignUpView : UIView
    {
        ...
        public string Email => emailInputField != null ? emailInputField.text : string.Empty;
        ...
        private void OnSetDefaultCredentialsEventHandler(EventMessage message)
        {
            ...
            if (credentials.Has(MstDictKeys.USER_NAME) && credentials.Has(MstDictKeys.USER_PASSWORD))
                SetInputFieldsValues(credentials.AsString(MstDictKeys.USER_NAME),
                    credentials.AsString(MstDictKeys.USER_EMAIL), credentials.AsString(MstDictKeys.USER_PASSWORD));
        }
