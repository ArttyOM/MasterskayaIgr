...
namespace MasterServerToolkit.Bridges.MySQL
{
    public abstract class MySqlDatabaseAccessorFactory : DatabaseAccessorFactory
    {
        ...
        [Header("Settings")]
        [SerializeField]
        [Tooltip("Use [connectionString] field to set your own connection string for database client")]
        protected string connectionString =
            "Server=localhost;Database=master_server_toolkit;Uid=root;Pwd=qazwsxedc123!@#;Port=3306;";

        [SerializeField] protected bool useGlobalConnectionstring = true;
