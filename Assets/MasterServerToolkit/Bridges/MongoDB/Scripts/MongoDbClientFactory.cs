...
namespace MasterServerToolkit.Bridges.MongoDB
{
    public class MongoDbClientFactory : MonoBehaviour
    {
        ...
        [SerializeField] private string databaseName = "masterServerToolkit";
        ...
        {
            if (string.IsNullOrEmpty(defaultConnectionString)) defaultConnectionString = "mongodb://localhost";

            if (string.IsNullOrEmpty(databaseName)) databaseName = "masterServerToolkit";
        }
