...
namespace MasterServerToolkit.Examples.BasicRoomsAndLobbies
{
    public class RoomInfoPanel : MonoBehaviour
    {
        ...
        [SerializeField] private TMP_Text roomSceneNameText;
        [SerializeField] private TMP_Text roomMaxPlayersText;
        ...
        {
            var onlineScene = Mst.Args.AsString(Mst.Args.Names.RoomOnlineScene, SceneManager.GetActiveScene().name);
