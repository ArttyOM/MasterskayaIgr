...
namespace MasterServerToolkit.Examples.BasicRoomsAndLobbies
{
    public class BasicRoomsAndLobbiesAndLobbiesBuild
    {
        ...
        {
            var buildFolder = Path.Combine("Builds", "BasicRoomsAndLobbies", "Room");
 ...
 isHeadless ? BuildOptions.ShowBuiltPlayer | BuildOptions.EnableHeadlessMode : BuildOptions.ShowBuiltPlayer
        ...
        {
            var buildFolder = Path.Combine("Builds", "BasicRoomsAndLobbies", "MasterAndSpawner");
            var roomExePath = Path.Combine(Directory.GetCurrentDirectory(), "Builds", "BasicRoomsAndLobbies", "Room",
                "Room.exe");
        ...
        {
            var buildFolder = Path.Combine("Builds", "BasicRoomsAndLobbies", "Spawner");
            var roomExePath = Path.Combine(Directory.GetCurrentDirectory(), "Builds", "BasicRoomsAndLobbies", "Room",
                "Room.exe");
        ...
        {
            var buildFolder = Path.Combine("Builds", "BasicRoomsAndLobbies", "Client");
