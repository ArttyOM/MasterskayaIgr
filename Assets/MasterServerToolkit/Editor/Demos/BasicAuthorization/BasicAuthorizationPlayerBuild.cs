...
namespace MasterServerToolkit.Examples.BasicAuthorization
{
    public class BasicAuthorizationPlayerBuild
    {
        ...
        {
            var buildFolder = Path.Combine("Builds", "BasicAuthorization", "MasterServer");

            var buildPlayerOptions = new BuildPlayerOptions
            {
                scenes = new[]
                    {"Assets/MasterServerToolkit/Demos/BasicAuthorization/Scenes/MasterServer/MasterServer.unity"},
        ...
        {
            var buildFolder = Path.Combine("Builds", "BasicAuthorization", "Client");
