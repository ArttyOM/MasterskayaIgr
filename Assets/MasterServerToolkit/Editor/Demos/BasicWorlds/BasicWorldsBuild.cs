...
namespace MasterServerToolkit.Examples.BasicWorlds
{
    public class BasicWorldsBuild
    {
        ...
        {
            var buildFolder = Path.Combine("Builds", "BasicWorlds", "Room");

            var buildPlayerOptions = new BuildPlayerOptions
            {
                scenes = new[]
                {
                    "Assets/MasterServerToolkit/Demos/BasicWorlds/Scenes/Room/Zone1.unity",
                    "Assets/MasterServerToolkit/Demos/BasicWorlds/Scenes/Room/Zone2.unity",
                    "Assets/MasterServerToolkit/Demos/BasicWorlds/Scenes/Room/Zone3.unity"
                },
...
#else
                options =
 isHeadless ? BuildOptions.ShowBuiltPlayer | BuildOptions.EnableHeadlessMode : BuildOptions.ShowBuiltPlayer
#endif
            };
            ...
            if (summary.result == BuildResult.Failed) Debug.Log("Room build failed");
        }
        ...
        {
            var buildFolder = Path.Combine("Builds", "BasicWorlds", "MasterAndSpawner");
            var roomExePath =
                Path.Combine(Directory.GetCurrentDirectory(), "Builds", "BasicWorlds", "Room", "Room.exe");

            var buildPlayerOptions = new BuildPlayerOptions
            {
                scenes = new[] {"Assets/MasterServerToolkit/Demos/BasicWorlds/Scenes/Master/Master.unity"},
            ...
            if (summary.result == BuildResult.Failed) Debug.Log("Master Server build failed");
        }

        [MenuItem(MstConstants.ToolMenu + "Build/Demos/Basic Worlds/Spawner")]
        private static void BuildSpawnerForWindows()
        {
            var buildFolder = Path.Combine("Builds", "BasicWorlds", "Spawner");
            var roomExePath =
                Path.Combine(Directory.GetCurrentDirectory(), "Builds", "BasicWorlds", "Room", "Room.exe");
            ...
            var buildPlayerOptions = new BuildPlayerOptions
            {
                scenes = new[]
                {
                    "Assets/MasterServerToolkit/Demos/BasicWorlds/Scenes/Spawner/Spawner.unity"
                },
            ...
            if (summary.result == BuildResult.Failed) Debug.Log("Spawner build failed");
        }

        [MenuItem(MstConstants.ToolMenu + "Build/Demos/Basic Worlds/Client")]
        private static void BuildClientForWindows()
        {
            var buildFolder = Path.Combine("Builds", "BasicWorlds", "Client");

            var buildPlayerOptions = new BuildPlayerOptions
            {
                scenes = new[]
                {
                    "Assets/MasterServerToolkit/Demos/BasicWorlds/Scenes/Client/Client.unity",
                    "Assets/MasterServerToolkit/Demos/BasicWorlds/Scenes/Room/Zone1.unity",
                    "Assets/MasterServerToolkit/Demos/BasicWorlds/Scenes/Room/Zone2.unity",
                    "Assets/MasterServerToolkit/Demos/BasicWorlds/Scenes/Room/Zone3.unity"
                },
