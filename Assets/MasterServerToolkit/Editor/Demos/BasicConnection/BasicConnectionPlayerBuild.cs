...
namespace MasterServerToolkit.Examples.BasicConnection
{
    public class BasicConnectionPlayerBuild
    {
        ...
        {
            var buildFolder = Path.Combine("Builds", "BasicConnection", "MasterServer");

            var buildPlayerOptions = new BuildPlayerOptions
            {
                scenes = new[]
                    {"Assets/MasterServerToolkit/Demos/BasicConnection/Scenes/MasterServer/MasterServer.unity"},
        ...
        {
            var buildFolder = Path.Combine("Builds", "BasicConnection", "Client");
