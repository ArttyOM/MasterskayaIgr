...
namespace MasterServerToolkit.MasterServer.Examples.Mirror
{
 ...
 isHeadless ? BuildOptions.ShowBuiltPlayer | BuildOptions.EnableHeadlessMode : BuildOptions.ShowBuiltPlayer
        ...
        private static void BuildMasterAndSpawnerForWindows()
        {
            ...
            string roomExePath =
 Path.Combine(Directory.GetCurrentDirectory(), "Builds", "Mirror", "BasicRoomsAndLobbies", "Room", "Room.exe");

            BuildPlayerOptions buildPlayerOptions = new BuildPlayerOptions
            {
                scenes =
 new[] { "Assets/MasterServerToolkit/Bridges/Mirror/BasicRoomsAndLobbies/Scenes/Master/Master.unity" },
