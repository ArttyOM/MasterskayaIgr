...
namespace MasterServerToolkit.MasterServer.Examples.FishNetworking
{
 ...
 isHeadless ? BuildOptions.ShowBuiltPlayer | BuildOptions.EnableHeadlessMode : BuildOptions.ShowBuiltPlayer
        ...
        private static void BuildMasterAndSpawnerForWindows()
        {
            ...
            string roomExePath =
 Path.Combine(Directory.GetCurrentDirectory(), "Builds", "FishNet", "BasicRoomsAndLobbies", "Room", "Room.exe");

            BuildPlayerOptions buildPlayerOptions = new BuildPlayerOptions
            {
                scenes =
 new[] { "Assets/MasterServerToolkit/Bridges/FishNet/BasicRoomsAndLobbies/Scenes/Master/Master.unity" },
