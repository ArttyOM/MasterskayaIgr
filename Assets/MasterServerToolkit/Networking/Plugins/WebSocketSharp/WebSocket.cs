...
namespace MasterServerToolkit.Networking
{
    public class WebSocket
    {
        ...
        public void Connect()
        {
            ...
            {
                if (e.IsPing) logger.Info("Received Pong responce from server");
            ...
            {
                logger.Debug(
                    $"WebSocket closed connection with code [{args.Code}:{(CloseStatusCode) args.Code}]. Reason: [{args.Reason}]");
