...
namespace MasterServerToolkit.Networking
{
    ...
    public class EndianBinaryReader : IDisposable
    {
        ...
        public EndianBinaryReader(EndianBitConverter bitConverter, Stream stream) : this(bitConverter, stream,
            Encoding.UTF8)
        {
        }
        ...
        public EndianBinaryReader(EndianBitConverter bitConverter, Stream stream, Encoding encoding)
        {
            ...
            if (encoding is UnicodeEncoding) minBytesPerChar = 2;
        }
        ...
        {
            CheckDisposed();
            if (buffer == null) throw new ArgumentNullException(nameof(data));
            ...
            if (byteBuffer.Length < count * minBytesPerChar) byteBuffer = new byte[4096];
        ...
        {
            if (disposed) throw new ObjectDisposedException("EndianBinaryReader");
        }
