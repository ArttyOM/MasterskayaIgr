...
namespace MasterServerToolkit.Networking
{
    ...
    public class EndianBinaryWriter : IDisposable
    {
        ...
        public EndianBinaryWriter(EndianBitConverter bitConverter, Stream stream) : this(bitConverter, stream,
            Encoding.UTF8)
        {
        }
        ...
        public EndianBinaryWriter(EndianBitConverter bitConverter, Stream stream, Encoding encoding)
        {
            ...
            if (!stream.CanWrite) throw new ArgumentException("Stream isn't writable", nameof(stream));
        ...
        public void Write(string value)
        {
            ...
            if (data.Length > short.MaxValue) throw new Exception("String is too long to be written like this");
        ...
        {
            if (disposed) throw new ObjectDisposedException("EndianBinaryWriter");
        }
