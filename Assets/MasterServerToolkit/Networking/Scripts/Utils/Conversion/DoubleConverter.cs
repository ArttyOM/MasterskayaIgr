    ...
    public class DoubleConverter
    {
        ...
        private class ArbitraryDecimal
        {
            ...
            internal ArbitraryDecimal(long x)
            {
                ...
                for (var i = 0; i < tmp.Length; i++) digits[i] = (byte) (tmp[i] - '0');
            ...
            internal void Normalize()
            {
                ...
                for (var i = 0; i < tmp.Length; i++) tmp[i] = digits[i + first];
            ...
            public override string ToString()
            {
                ...
                for (var i = 0; i < digits.Length; i++) digitString[i] = (char) (digits[i] + '0');
