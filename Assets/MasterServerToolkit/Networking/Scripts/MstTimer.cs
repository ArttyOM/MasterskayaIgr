...
namespace MasterServerToolkit.Networking
{
    ...
    public class MstTimer : DynamicSingletonBehaviour<MstTimer>
    {
        ...
        public static void WaitUntil(Func<bool> condition, TimerActionCompleteHandler completeCallback,
        ...
        /// <param name="completeCallback"></param>
        /// <param name="timeoutSeconds"></param>
        public static void WaitWhile(Func<bool> condition, TimerActionCompleteHandler completeCallback,
            float timeoutSeconds)
        {
            if (TryGetOrCreate(out var instance))
                instance.StartCoroutine(instance.WaitWhileTrueCoroutine(condition, completeCallback, timeoutSeconds));
        ...
        /// <returns></returns>
        private IEnumerator WaitWhileTrueCoroutine(Func<bool> condition, TimerActionCompleteHandler completeCallback,
