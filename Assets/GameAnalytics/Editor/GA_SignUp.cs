...
namespace GameAnalyticsSDK.Editor
{
    ...
    {
        private GUIContent _firstNameLabel = new("First name", "Your first name.");
        private GUIContent _lastNameLabel = new("Last name", "Your last name (surname).");

        private GUIContent _studioNameLabel = new("Studio name",
            "Your studio's name. You can add more studios and games on the GameAnalytics website.");

        private GUIContent _organizationNameLabel = new("Organization name",
            "Your organization's name. You can add more studios and games under your organization on the GameAnalytics website.");

        private GUIContent _organizationIdentifierLabel = new("Organization identifier",
            "Your organization's identifier to be used in url. Must be unique. Can only contain lowercase letters, digits and hyphens");

        private GUIContent _gameNameLabel = new("Game name",
            "Your game's name. You can add more studies and games on the GameAnalytics website.");

        private GUIContent _passwordConfirmLabel = new("Confirm password", "Your GameAnalytics user account password.");

        private GUIContent _emailOptInLabel = new("Subscribe to release updates, news and tips and tricks.",
            "If enabled GameAnalytics may send you news about updates, cool tips and tricks, and other news to help you get the most out of our service.");

        private GUIContent _termsLabel = new("I have read and agree with your");
        ...
        private void OnGUI()
        {
            switch (TourStep)
            {
                ...
                case 0: // sign up
                    ...
                    GUILayout.BeginHorizontal();
                    GUILayout.FlexibleSpace();
                    GameAnalytics.SettingsGA.EmailGA = EditorGUILayout.TextField("", GameAnalytics.SettingsGA.EmailGA,
                        GUILayout.Width(INPUT_WIDTH));
                    GUILayout.FlexibleSpace();
                    GUILayout.EndHorizontal();
                    ...
                    GUILayout.BeginHorizontal();
                    GUILayout.FlexibleSpace();
                    GameAnalytics.SettingsGA.PasswordGA = EditorGUILayout.PasswordField("",
                        GameAnalytics.SettingsGA.PasswordGA, GUILayout.Width(INPUT_WIDTH));
                    GUILayout.FlexibleSpace();
                    GUILayout.EndHorizontal();
                    ...
                    GUILayout.BeginHorizontal();
                    GUILayout.FlexibleSpace();
                    GameAnalytics.SettingsGA.StudioName = EditorGUILayout.TextField("",
                        GameAnalytics.SettingsGA.StudioName, GUILayout.Width(INPUT_WIDTH));
                    GUILayout.FlexibleSpace();
                    GUILayout.EndHorizontal();
                    ...
                    GUILayout.BeginHorizontal();
                    GUILayout.FlexibleSpace();
                    GameAnalytics.SettingsGA.OrganizationName = EditorGUILayout.TextField("",
                        GameAnalytics.SettingsGA.OrganizationName, GUILayout.Width(INPUT_WIDTH));
                    GUILayout.FlexibleSpace();
                    GUILayout.EndHorizontal();
                    ...
                    GUILayout.BeginHorizontal();
                    GUILayout.FlexibleSpace();
                    GameAnalytics.SettingsGA.OrganizationIdentifier = EditorGUILayout.TextField("",
                        GameAnalytics.SettingsGA.OrganizationIdentifier, GUILayout.Width(INPUT_WIDTH));
                    GUILayout.FlexibleSpace();
                    GUILayout.EndHorizontal();
                    ...
                    else
                    {
                        EditorGUILayout.HelpBox(
                            "Please read and agree with our terms before you can create an account.",
                            MessageType.Warning);
                    }
                ...
                case 1: // add your game
                    ...
                    GUILayout.BeginHorizontal();
                    GUILayout.FlexibleSpace();
                    var tmpFontSize = GUI.skin.textField.fontSize;
                    var tmpOffset = GUI.skin.textField.contentOffset;
                    GUI.skin.textField.fontSize = 12;
                    GUI.skin.textField.contentOffset = new Vector2(6, 6);
                    GameAnalytics.SettingsGA.GameName = EditorGUILayout.TextField("", GameAnalytics.SettingsGA.GameName,
                        new GUILayoutOption[]
                        {
                            GUILayout.Width(300),
                            GUILayout.Height(30)
                    ...
                    if (_appFiguresGames != null && _appFiguresGames.Count > 0)
                    {
                        ...
                        GUILayout.BeginHorizontal();
                        GUILayout.FlexibleSpace();
                        GUILayout.Label("'" + _appFigName + "' matched " + _appFiguresGames.Count + " titles.",
                        ...
                        for (var i = 0; i < _appFiguresGames.Count; i++)
                        {
                            GUILayout.BeginHorizontal();
                            ...
                            var tmpOffsetLabel = GUI.skin.label.contentOffset;
                            ...
                            var appFigRect = new Rect(lastRect.x - 5, lastRect.y - 5, lastRect.width + 520,
                                lastRect.height + 10);
                    ...
                    GUILayout.FlexibleSpace();
                    GUILayout.Label(
                        "If your game is still in development or not in the app store, please add it manually.");
                    GUILayout.FlexibleSpace();
                    GUILayout.EndHorizontal();
                ...
                case 2: // create new game
                    ...
                    GUILayout.BeginHorizontal();
                    GUILayout.FlexibleSpace();
                    var tmpFontSize2 = GUI.skin.textField.fontSize;
                    var tmpOffset2 = GUI.skin.textField.contentOffset;
                    GUI.skin.textField.fontSize = 12;
                    ...
                    GUILayout.BeginHorizontal();
                    GUILayout.FlexibleSpace();
                    _selectedOrganization = EditorGUILayout.Popup("", _selectedOrganization,
                        Organization.GetOrganizationNames(GameAnalytics.SettingsGA.Organizations, false),
                        GUILayout.Width(200));
                    GUILayout.FlexibleSpace();
                    GUILayout.EndHorizontal();
                    ...
                    GUILayout.BeginHorizontal();
                    GUILayout.FlexibleSpace();
                    _selectedStudio = EditorGUILayout.Popup("", _selectedStudio,
                        _selectedOrganization > 0
                            ? Studio.GetStudioNames(
                                GameAnalytics.SettingsGA.Organizations[_selectedOrganization - 1].Studios, false)
                            : new string[0], GUILayout.Width(200));
                    GUILayout.FlexibleSpace();
                    GUILayout.EndHorizontal();
                    ...
                    _selectedPlatform = (RuntimePlatform) EditorGUILayout.Popup("", (int) _selectedPlatform,
                        settings.GetAvailablePlatforms(), GUILayout.Width(200));
                    GUILayout.FlexibleSpace();
                    GUILayout.EndHorizontal();

                    if (_selectedPlatform == RuntimePlatform.Android)
                    {
                        GUILayout.BeginHorizontal();
                        EditorGUILayout.HelpBox(
                            "PLEASE NOTICE: If you want to validate your Android in-app purchase please enter your Google Play License key (public key). Click here to learn more about the Google Play License key.",
                            MessageType.Info);
                        ...
                        _googlePlayPublicKey = GUILayout.TextField(_googlePlayPublicKey);
                        GUILayout.EndHorizontal();
                    }
                        ...
                        }))
                    {
                        ...
                        GA_SettingsInspector.CreateGame(GameAnalytics.SettingsGA, this, _selectedOrganization,
                            _selectedStudio, GameAnalytics.SettingsGA.GameName, _googlePlayPublicKey, _selectedPlatform,
                            null);
                    }
                    ...
                    var r3 = new Rect(r1.x, r1.y, r1.width + r2.width, r2.height);
                    if (GUI.Button(r3, "", GUIStyle.none)) TourStep = 1;
                ...
                case 3: // app figures add game
                        ...
                        }))
                    {
                        _createGameInProgress = true;
                        _selectedPlatform =
                            _appFiguresGame.Store.Equals("google_play") ||
                            _appFiguresGame.Store.Equals("amazon_appstore")
                                ? RuntimePlatform.Android
                                : RuntimePlatform.IPhonePlayer;
                        GA_SettingsInspector.CreateGame(GameAnalytics.SettingsGA, this, _selectedOrganization,
                            _selectedStudio, _appFiguresGame.Name, _googlePlayPublicKey, _selectedPlatform,
                            _appFiguresGame);
                    }
                    ...
                    GUILayout.FlexibleSpace();
                    GUILayout.Label("Go back to ");
                    var r21 = GUILayoutUtility.GetLastRect();
                    GUILayout.Space(-5);
                    GUILayout.BeginVertical();
                    GUILayout.Space(2);
                    GUILayout.Label("results", EditorStyles.boldLabel);
                    GUILayout.EndVertical();
                    var r22 = GUILayoutUtility.GetLastRect();
                    var r23 = new Rect(r21.x, r21.y, r21.width + r22.width, r22.height);
                    if (GUI.Button(r23, "", GUIStyle.none)) TourStep = 1;
                ...
                case 4:
                    ...
                    GUILayout.BeginHorizontal();
                    GUILayout.FlexibleSpace();
                    var tmpLA = GUI.skin.label.alignment;
                    GUI.skin.label.alignment = TextAnchor.UpperCenter;
                    GUILayout.Label(
                        "We've put together a simple guide to help you instrument GameAnalytics in your game.",
                        GUILayout.MaxWidth(540));
                ...
                case 14:
                    ...
                    GUILayout.FlexibleSpace();
                    if (guideStep == 10)
                        GUILayout.Label(GetGuideStepTitle(guideStep), EditorStyles.whiteLargeLabel,
                            GUILayout.Width(464));
                    else
                        GUILayout.Label(GetGuideStepTitle(guideStep), EditorStyles.whiteLargeLabel,
                            GUILayout.Width(470));
                    ...
                    GUILayout.FlexibleSpace();
                    GUILayout.BeginVertical();
                    var guideStepTexts = GetGuideStepText(guideStep);
                    foreach (var s in guideStepTexts)
                        ...
                        {
                            var tmpA = GUI.skin.textField.alignment;
                            var tmpFS = GUI.skin.textField.fontSize;
                        ...
                        else if (s.Type == StringType.Link)
                        {
                            ...
                            var sl = GUI.skin.button.CalcSize(new GUIContent(s.Text)).x;
                    ...
                    if (TourStep == 14) buttonText = "Done";
                    ...
                    //GUILayout.EndVertical();
                    if (guideStep > 1 && GUI.Button(new Rect(454, 0, 30, 30), "<")) TourStep--;
            ...
            switch (step)
            {
                case 1:
                    return new StringWithType[]
                    {
                        ...
                        {
                            Text =
                                "The unique game and secret key are used to authenticate your game. If you're logged into GameAnalytics, in Settings under the Account tab, choose your studio and game to sync your keys with your Unity project. If you don't have an account, choose Sign up to create your account and game."
                        },
                        new()
                        {
                            Text =
                                "You can also input your keys manually in Settings under the Setup tab. The keys can always be found under Game Settings in the webtool."
                        },
                        new() {Text = ""},
                        new()
                        {
                ...
                case 2:
                    return new StringWithType[]
                    {
                        ...
                        {
                            Text =
                                "To use GameAnalytics you need to add the GameAnalytics object to your starting scene. To add this object go to Window/GameAnalytics/Create GameAnalytics Object."
                        },
                        new()
                        {
                            Text =
                                "Now you're set up to start tracking data - it's that easy! Out of the box GameAnalytics will give you access to lots of core metrics, such as daily active users (DAU), without implementing any custom events."
                        },
                        new() {Text = ""},
                        new()
                        {
                ...
                case 3:
                    return new StringWithType[]
                    {
                        ...
                        new() {Text = "To send an event, remember to include the namespace GameAnalyticsSDK:"},
                        new()
                        {
                ...
                case 4:
                    return new StringWithType[]
                    {
                        ...
                        {
                            Text =
                                "With the Business event, you can include information on the specific type of in-app item purchased, and where in the game the purchase was made. Additionally, the GameAnalytics SDK captures the app store receipt to validate the purchases."
                        },
                        new() {Text = "To add a business event call the following function:"},
                        new()
                        {
                            Text =
                ...
                case 5:
                    return new StringWithType[]
                    {
                        ...
                        new() {Text = "To add a resource event call the following function:"},
                        new()
                        {
                            Text =
                        ...
                        {
                            Text =
                                "Please note that any Resource Currencies and Resource Item Types you want to use must first be defined in Settings, under the Setup tab. Any value which is not defined will be ignored."
                        },
                        new() {Text = ""},
                        new()
                        {
                ...
                case 6:
                    return new StringWithType[]
                    {
                        ...
                        new() {Text = "To add a progression event call the following function:"},
                        new()
                        {
                            Text =
                ...
                case 7:
                    return new StringWithType[]
                    {
                        ...
                        {
                            Text =
                                "Track any other concept in your game using this event type. For example, you could use this event to track GUI elements or tutorial steps. Custom dimensions are not supported on this event type."
                        },
                        new() {Text = "To add a design event call the following function:"},
                        new()
                        {
                ...
                case 8:
                    return new StringWithType[]
                    {
                        ...
                        {
                            Text =
                                "You can use the Error event to log errors or warnings that players generate in your game. You can group the events by severity level and attach a message, such as the stack trace."
                        },
                        new() {Text = "To add a custom error event call the following function:"},
                        new()
                        {
                ...
                case 9:
                    return new StringWithType[]
                    {
                        ...
                        {
                            Text =
                                "Custom Dimensions can be used to filter your data in the GameAnalytics webtool. To add custom dimensions to your events you will first have to create a list of all the allowed values. You can do this in Settings under the Setup tab. Any value which is not defined will be ignored."
                        },
                        new() {Text = "For example, to set Custom Dimension 01, call the following function:"},
                        new()
                        {
                ...
                case 10:
                    return new StringWithType[]
                    {
                        ...
                        {
                            Text =
                                "You're almost there! To complete the integration and start sending data to GameAnalytics, all you need to do is build and run your game."
                        },
#if UNITY_IOS || UNITY_TVOS || UNITY_ANDROID
                        new StringWithType {Text =
 "The link below describes the important last steps you need to complete to build for the build platform you selected in the editor."},
#endif
                        new() {Text = ""},
...
#else
                    new StringWithType { Text =
 "Your selected build platform is not currently supported by GameAnalytics." },
                    new StringWithType { Text =
 "The Unity SDK includes support for Windows, Mac, Linux, WebGL, iOS, tvOS, UWP, Tizen, Universal Windows 8 and Android.", Type
 = StringType.Link, Link = "https://github.com/GameAnalytics/GA-SDK-UNITY" },
            ...
            try
            {
...
#endif
                {
                    switch (storeName)
                    {
                        case "amazon_appstore":
#if UNITY_2017_1_OR_NEWER
                            GameAnalytics.SettingsGA.AmazonIcon =
                        ...
                        case "windows_phone":
#if UNITY_2017_1_OR_NEWER
                            GameAnalytics.SettingsGA.windowsPhoneIcon =
                                ((DownloadHandlerTexture) www.downloadHandler).texture;
#else
    ...
    public class AppFiguresGame
    {
        ...
        public AppFiguresGame(string name, string appID, string store, string developer, string iconUrl,
            GA_SignUp signup)
        {
            Name = name;
            AppID = appID;
...
#if UNITY_2017_1_OR_NEWER
            var www = UnityWebRequestTexture.GetTexture(iconUrl);
