    ...
    public class Sample01_ObservableWWW : MonoBehaviour
    {
        private void Start()
        {
            ...
            // download after google, start bing download
            {
                ...
                var cancel =
                    query.Subscribe(x => Debug.Log(x.google.Substring(0, 100) + ":" + x.bing.Substring(0, 100)));
            ...
            // with Error
            {
                ...
                ObservableWWW.Get("http://www.google.com/404")
                    .CatchIgnore((WWWErrorException ex) =>
                    {
                        ...
                        if (ex.HasResponse) Debug.Log(ex.StatusCode);
                        foreach (var item in ex.ResponseHeaders) Debug.Log(item.Key + ":" + item.Value);
                    })
                    .Subscribe();
            }
        }
