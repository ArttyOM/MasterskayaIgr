...
namespace UniRx.Triggers
{
    ...
    public class ObservableTrigger2DTrigger : ObservableTriggerBase
    {
        ...
        {
            if (onTriggerEnter2D != null) onTriggerEnter2D.OnCompleted();
            if (onTriggerExit2D != null) onTriggerExit2D.OnCompleted();
            if (onTriggerStay2D != null) onTriggerStay2D.OnCompleted();
        }
    }
}