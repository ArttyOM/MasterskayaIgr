...
namespace UniRx.Triggers
{
    ...
    public class ObservableMouseTrigger : ObservableTriggerBase
    {
        ...
        {
            if (onMouseDown != null) onMouseDown.OnCompleted();
            if (onMouseDrag != null) onMouseDrag.OnCompleted();
            if (onMouseEnter != null) onMouseEnter.OnCompleted();
            if (onMouseExit != null) onMouseExit.OnCompleted();
            if (onMouseOver != null) onMouseOver.OnCompleted();
            if (onMouseUp != null) onMouseUp.OnCompleted();
            if (onMouseUpAsButton != null) onMouseUpAsButton.OnCompleted();
        }
    }
}
