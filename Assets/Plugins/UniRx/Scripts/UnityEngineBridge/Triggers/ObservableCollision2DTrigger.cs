...
namespace UniRx.Triggers
{
    ...
    public class ObservableCollision2DTrigger : ObservableTriggerBase
    {
        ...
        {
            if (onCollisionEnter2D != null) onCollisionEnter2D.OnCompleted();
            if (onCollisionExit2D != null) onCollisionExit2D.OnCompleted();
            if (onCollisionStay2D != null) onCollisionStay2D.OnCompleted();
        }
    }
}