...
namespace UniRx.Triggers
{
    ...
    public class ObservableTransformChangedTrigger : ObservableTriggerBase
    {
        ...
        {
            if (onBeforeTransformParentChanged != null) onBeforeTransformParentChanged.OnCompleted();
            if (onTransformParentChanged != null) onTransformParentChanged.OnCompleted();
            if (onTransformChildrenChanged != null) onTransformChildrenChanged.OnCompleted();
        }
    }
}
